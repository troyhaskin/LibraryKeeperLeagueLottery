...
function uheprng() {
    ...
    return (function() {
        ...
        /*
            Cleaning up the object a little for my liking
        */
        ...
        /*
            Added uniform method since it should already be here.
        */
...
function draftSpec() {
    ...
    for (var k = 0; k < 50; k ++ ) {
        prng.addEntropy(Math.random(),prng.string(16));
    }
    ...
    return {
        ...
        proto: {
            performDrawingWithoutReplacement: 
                function (shuffle) {
            ...
            sampleNRounds: function (n,shuffle) {
                if(n === undefined) {
                    n = 100;
                }
            ...
            verifySampling: function (n,shuffle) {
                if(n === undefined) {
                    n = 100;
                }
                if ( shuffle === undefined || shuffle !== false || shuffle !== true) {
